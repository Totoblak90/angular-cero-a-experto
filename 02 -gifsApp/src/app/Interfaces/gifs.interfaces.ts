// To parse this data:
//
//   import { Convert, SearchType } from "./file";
//
//   const searchType = Convert.toSearchType(json);
//
...
export class Convert {
    public static toSearchType(json: string): SearchType {
        return cast(JSON.parse(json), r("SearchType"));
    }

    public static searchTypeToJson(value: SearchType): string {
        return JSON.stringify(uncast(value, r("SearchType")), null, 2);
    }
}
