...
//
//   const buscarPaisType = Convert.toBuscarPaisType(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface BuscarPaisType {
    name:           string;
...
export class Convert {
    public static toBuscarPaisType(json: string): BuscarPaisType[] {
        return cast(JSON.parse(json), a(r("BuscarPaisType")));
    }

    public static buscarPaisTypeToJson(value: BuscarPaisType[]): string {
        return JSON.stringify(uncast(value, a(r("BuscarPaisType"))), null, 2);
    }
}
